  ...
  return (
    ...
    >
      <div className="mx-auto max-w-4xl">
        ...
        >
          <h3
            className={`mb-6 font-[family-name:var(--font-display)] text-2xl tracking-wider ${theme.subheading}`}
          >
            Publications
          </h3>
          <div className="space-y-5">
            {publications.map((pub, index) => (
              ...
              >
                <h4 className={`mb-1 text-lg font-semibold ${theme.projectTitle}`}>
                  {pub.title}
                </h4>
                ...
                <a href={pub.link} className={`text-sm font-medium ${theme.projectLink}`}>
                  Read paper →
                </a>
              </motion.article>
            ))}
