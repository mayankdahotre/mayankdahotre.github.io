export const themes = {
  ...
  luxury: {
    ...
    projectTitle:
      "font-display text-2xl tracking-wide text-luxury-gold",
    projectTag:
    ...
    primaryBtn:
      "luxury-gradient inline-block rounded-sm px-10 py-4 font-display text-xl tracking-wider text-black transition-transform hover:scale-105",
    secondaryBtn:
      "inline-block rounded-sm border border-luxury-gold/50 px-10 py-4 font-display text-xl tracking-wider text-luxury-gold transition-all hover:border-luxury-gold hover:bg-luxury-gold/10 hover:scale-105",
