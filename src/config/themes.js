export const themes = {
  ...
  luxury: {
    ...
    skillTag:
      "rounded-sm border border-luxury-gold/35 bg-luxury-card-bg px-4 py-2 text-sm text-luxury-gold transition-colors hover:border-luxury-gold-light hover:luxury-glow",
    projectCard:
      "group flex flex-col rounded-sm border border-luxury-gold/25 luxury-card-bg p-6 transition-all hover:border-luxury-gold/50 hover:luxury-glow",
    projectTitle: "font-display text-2xl tracking-wide text-luxury-gold",
    projectTag:
      "rounded-sm border border-luxury-gold/25 bg-black px-2 py-1 text-xs text-luxury-gold-light",
    projectLink:
      "text-luxury-gold transition-colors hover:text-luxury-gold-light",
    socialBtn:
      "flex h-14 w-14 items-center justify-center rounded-sm border border-luxury-gold/35 bg-black text-luxury-gold transition-all hover:border-luxury-gold-light hover:text-luxury-gold-light hover:luxury-glow",
    primaryBtn:
      "luxury-gradient inline-block rounded-md px-10 py-4 font-display text-xl tracking-wider text-black transition-transform hover:scale-105 hover:luxury-glow",
    secondaryBtn:
      "inline-block rounded-md border border-luxury-gold/50 bg-black px-10 py-4 font-display text-xl tracking-wider text-luxury-gold transition-all hover:border-luxury-gold-light hover:luxury-glow hover:scale-105",
    sectionOverlay: "luxury-section-glow",
    footer: "border-luxury-gold/25 text-luxury-muted",
  },
};
