export const themes = {
  gta: {
    ...
    projectTitle: "font-[family-name:var(--font-display)] text-2xl tracking-wide text-gta-yellow",
    ...
    primaryBtn:
      "gta-gradient inline-block rounded-sm px-10 py-4 font-[family-name:var(--font-display)] text-xl tracking-wider text-white transition-transform hover:scale-105",
    secondaryBtn:
      "inline-block rounded-sm border border-gta-orange/50 px-10 py-4 font-[family-name:var(--font-display)] text-xl tracking-wider text-gta-yellow transition-all hover:border-gta-yellow hover:bg-gta-purple/30 hover:scale-105",
  ...
  luxury: {
    ...
    muted: "text-white/60",
    skillTag:
      "rounded-sm border border-luxury-gold/25 bg-luxury-charcoal/80 px-4 py-2 text-sm text-luxury-gold-light backdrop-blur-sm transition-colors hover:border-luxury-gold/50 hover:bg-luxury-gold/10",
    projectCard:
      "group flex flex-col rounded-sm border border-luxury-gold/15 bg-luxury-charcoal/60 p-6 backdrop-blur-sm transition-all hover:border-luxury-gold/40 hover:luxury-glow",
    projectTitle:
    ...
    socialBtn:
      "flex h-14 w-14 items-center justify-center rounded-sm border border-luxury-gold/20 bg-luxury-charcoal/80 text-luxury-gold-light transition-all hover:border-luxury-gold/50 hover:text-luxury-gold hover:luxury-glow",
    primaryBtn:
